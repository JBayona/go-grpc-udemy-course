...
func (x *ComputerAverageRequest) GetNumber() int64 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *ComputerAverageResponse) GetResult() int64 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xab, 0x02, 0x0a, 0x11, 0x43,
